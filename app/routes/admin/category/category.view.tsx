...
import { TypeAction, TypeSubject, type CategoryModel } from '@/models';
import { CategoryCreate, CategoryTable } from '.';
import { Button } from '@/components';
import { useCategoryStore, usePermissionStore } from '@/hooks';
  ...
  return (
    <>
      ...
      <div className="flex justify-between items-center mb-4">
        ...
        {
          hasPermission(TypeAction.create, TypeSubject.category) &&
          <Button
